...
backup_base_dir = fullfile('Y:',sprintf('backup_%s', timestamp));
multiwork_path = 'M:\';
backup_multiwork_files(multiwork_path, backup_base_dir);

% Directory to store the ZIP file
zip_destination_dir = 'Y:\multiwork_active_exp_backup\data_backup'; 
